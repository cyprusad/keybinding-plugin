...
assert(payloads[1] == "keybind-dojo:v1:guide:down:SUPER")
...
assert(payloads[5] == "keybind-dojo:v1:guide:up")
...
assert(payloads[6] == "keybind-dojo:v1:guide:down:ALT")
assert(payloads[7] == "keybind-dojo:v1:mods:SHIFT_ALT")
assert(payloads[8] == "keybind-dojo:v1:mods:ALT")
assert(payloads[9] == "keybind-dojo:v1:guide:up")
