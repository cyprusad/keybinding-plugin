...
| 03 — Omakeez overlay | Planned | pending | Rebrand the visual reference, remove activity persistence/gamification and bar badges, then reduce the panel to integration, fullscreen behavior, security documentation, and catalog access. See `UX_POLISH_02_OMAKEEZ_OVERLAY.md`. |
